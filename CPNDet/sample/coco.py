...
def kp_detection(db, k_ind, data_aug, debug):
    ...
    for b_ind in range(batch_size):
        ...
        for ind, detection in enumerate(detections):
            ...
            '''
            category = 0    # RPN does not require class
            #category = 0
    ...
    return {
        "xs": [images, tl_tags, br_tags, gt_bboxes, tag_lens, ct_tags],
        "ys": [tl_heatmaps, br_heatmaps, tag_masks, tl_regrs, br_regrs , ct_heatmaps, ct_regrs]
    }, k_ind
